...
<body class="g-sidenav-show  bg-gray-100">
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="text-dark mb-4">
      This is a website about User CRUD and Login progess for the 4th semester test. <br> Using Laravel and PHPMyAdmin for the database. <br><br>
        Name : Muhammad Fariz Al-Haq. <br>
        Grade : XI PPLG. <br>
        Teacher : Mr. Eko Saputra, A.Md.    <br><br>
       <?php
