            ...
            <div class="table-responsive p-3">
                <table class="table p-3">
                    ...
                    <tr>
                      ...
                      <!-- <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Level</th> -->
                    ...
                    <th>Action</th>
                         <td>
                            <a class="form-control btn btn-primary" href="/editprofile/{{session()->get('user_id')}}">Edit</a>
                        </td>
                        <td>
                             <a class="form-control btn btn-secondary" href="/dashboard">Back</a>
                        </td>
                    </tr>
