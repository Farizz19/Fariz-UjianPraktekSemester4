          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">User Edit Form</h6>
              ...
              <div class="table-responsive p-0">
                @foreach($user as $u)
                <form class="p-3" action="/update/{{$u->user_id}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-secondary form-control" href="/user">Back</a>
                    </div>
                </form>
                @endforeach
              </div>
