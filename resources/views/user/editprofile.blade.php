          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">User Profile Edit</h6>
              ...
              <div class="table-responsive p-0">
                @foreach($user as $u)
                <form class="p-3" action="/updateprofile/{{$u->user_id}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label>Username</label>
                        <input type="username" class="form-control" name="username" value="{{$u->username}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-secondary form-control" href="/profile">Back</a>
                    </div>
                </form>
                @endforeach
              </div>
